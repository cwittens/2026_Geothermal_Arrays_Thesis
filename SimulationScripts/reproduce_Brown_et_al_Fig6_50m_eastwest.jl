...
#
# This script reproduces the 50 m spacing case from Figure 6:
...
# =============================================================================
# Borehole geometry: 5-DBHE east-west line array, 50 m spacing
# =============================================================================
# Brown et al. Table 1:
# - DBHE depth = 922 m
...
borehole_spacing = 50.0
XC = collect(-2borehole_spacing:borehole_spacing:2borehole_spacing)  # [-100, -50, 0, 50, 100] m
...
data_file = joinpath(simulation_data_dir(), "Brown_et_al_line_array_50m_eastwest.jld2")
