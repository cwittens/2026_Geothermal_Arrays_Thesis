...
#
# This script reproduces the 20 m spacing case from Figure 6:
...
# =============================================================================
# Borehole geometry: 5-DBHE east-west line array, 20 m spacing
# =============================================================================
# Brown et al. Table 1:
# - DBHE depth = 922 m
...
borehole_spacing = 20.0
XC = collect(-2borehole_spacing:borehole_spacing:2borehole_spacing)  # [-40, -20, 0, 20, 40] m
...
data_file = joinpath(simulation_data_dir(), "Brown_et_al_line_array_20m_eastwest.jld2")
